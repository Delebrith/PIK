...
public class ExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler({InvalidAuthorityException.class, InvalidProjectDataException.class,
            InvalidProjectSettingsChangeException.class})
    @ResponseBody
